...
export default {
  ...
  methods:{
     callingAxios0(){
      ...
      let endpoint = "https://satelite-de-noticias.herokuapp.com/api/rest-auth/registration/"
    ...
    callingAxios(){
      ...
      let endpoint = "https://satelite-de-noticias.herokuapp.com/api/rest-auth/login/"
      apiService(endpoint, "POST", {
          username: "admin10",
